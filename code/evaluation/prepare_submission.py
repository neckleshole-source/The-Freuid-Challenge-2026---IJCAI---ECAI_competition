    ...
    with torch.no_grad():
        for path in test_images:
            try:
                ...
                country = "GUINEA" if "Guinée" in fn_upper else "MAURITIUS" if "MAURITIUS" in fn_upper else "BENIN" if "BÉNIN" in fn_upper else "EGYPT" if "ET" in fn_upper else "MOZAMBIQUE"  if "MOÇAMBIQUE" in fn_upper else "UNKNOWN"
